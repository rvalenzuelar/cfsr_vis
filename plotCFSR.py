...
def main():
    ...
    cfsr = CFSR.create(domain=domain, dates=dates[:-1],
    ...
    cfsr.geothickness(
        top=500, bottom=1000, clevels=range(5100, 5730, 30), cmap='RdBu_r')
    ...
    cfsr.windvector(
        level=1000, jump=4, width=0.5, scale=1.5, key=20, colorkey='white')
